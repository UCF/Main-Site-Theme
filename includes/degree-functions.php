						...
						<div class="accordion" role="tablist" id="courses">
							<?php while ( have_rows( 'course_overview', $degree ) ) : the_row(); ?>
								<div class="accordion-courses mt-0 pt-0 pt-lg-3">
									<h3 class="mb-0">
										<a <?php if ( get_row_index() !== 1 ) echo 'class="collapsed"' ?> data-toggle="collapse" data-target="#course-<?php echo get_row_index(); ?>" aria-controls="course-<?php echo get_row_index(); ?>" role="button" tabindex="0" aria-expanded="true">
