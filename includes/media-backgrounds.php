...
function get_media_background_video( $videos, $loop=false ) {
	ob_start();
?>
	<video class="media-background media-background-video object-fit-cover" aria-hidden="true" preload="none" muted <?php if ( $loop ) { ?>loop<?php } ?>>
		...
		<?php if ( isset( $videos['mp4_xs'] ) ) : ?>
		<source src="<?php echo $videos['mp4_xs']; ?>" type="video/mp4">
		<?php endif; ?>
