...
function get_media_background_video( $videos, $loop=false ) {
	ob_start();
?>
	<video class="hidden-xs-down media-background media-background-video object-fit-cover" aria-label="main header video banner" aria-hidden="true" preload="none" muted <?php if ( $loop ) { ?>loop<?php } ?>>
