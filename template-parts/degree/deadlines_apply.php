...
$undergraduate_deadline_disclaimer = get_theme_mod( 'degree_deadlines_undergraduate_disclaimer' ) ?: null;
$graduate_deadline_disclaimer = get_theme_mod( 'degree_deadlines_graduate_disclaimer' ) ?: null;
				...
				<div class="degree-deadline-row">
					...
					<div class="degree-deadline-content degree-deadline-content-deadlines">
						<div class="row no-gutters w-100 h-100 d-lg-flex flex-wrap align-items-lg-center">
							...
							<?php if ( $undergraduate_deadline_disclaimer || $graduate_deadline_disclaimer ) : ?>
							<div class="<?php echo $deadline_groups_col_class; ?>">
							<?php
								if ( ! is_graduate_degree( $post ) && $undergraduate_deadline_disclaimer ) {
									echo $undergraduate_deadline_disclaimer;
								} elseif ( is_graduate_degree( $post ) && $graduate_deadline_disclaimer ) {
									echo $graduate_deadline_disclaimer;
								}
							?>
							</div>
							<?php endif; ?>
