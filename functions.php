...
function output_weather_data($class=null) {
	...
	<div id="weather_bug" class="<?=$class?>">
		<div id="wb_status_txt" style="background: url(<?php bloginfo('stylesheet_directory'); ?>/static/img/weather/<?=$img?>.png) left center no-repeat; background-size: 32px 32px"><span><?=$temp?>F, <?=$condition?></span></div>
	</div>
	<?php
}
